...
<div class="username" data-uid="{account_id}" data-id="{contract_id}">
	<div class="worker-photo" style="box-sizing: border-box;background-image: url(/egroupware/attendance/image.php?id={account_id}&amp;etag=8);"></div><span class="name">{account_firstname} {account_lastname}</span>
</div>
';
